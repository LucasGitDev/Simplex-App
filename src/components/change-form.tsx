...
import { isActive } from "@/lib/analysis";
import { cn } from "@/lib/utils";
import type { ChangeProblem, Problem, Solution } from "@/types/simplex";
...
export function ChangeForm({ onSubmit, problem, solution }: ChangeFormProps) {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-4">
          <h3 className="text-lg font-medium">
            {" "}
            Alterações Propostas nos Recursos
          </h3>
            ...
            {problem.constraintNames.map((row, i) => (
              ...
              >
                ...
                <div
                  className={cn(
                    "space-y-1",
                    !isActive(solution.tableau, i) && "opacity-50"
                  )}
                >
